...
export default defineConfig({
	...
	redirects: {
		...
		...i18nRedirect(
			"/v1/guides/debugging/application",
			"/guides/debug/application",
		),
		...i18nRedirect(
			"/v1/guides/debugging/vs-code",
			"/guides/debug/vs-code",
		),
		...i18nRedirect(
			"/v1/guides/debugging/rustrover",
			"/guides/debug/rustrover",
		),
		...
		...i18nRedirect(
			"/v1/guides/distribution/publishing",
			"/guides/distribute/",
		),
		...
		...i18nRedirect(
			"/v1/reference/architecture/process-model",
			"/concepts/process-model",
		),
		...i18nRedirect(
			"/v1/reference/architecture/security",
			"/concepts/tauri-security",
		),
		...i18nRedirect(
		...
		...i18nRedirect(
			"/v1/reference/security",
			"/concepts/development-security",
		),
		...i18nRedirect(
			"/v1/reference/configuration-files",
			"/reference/configuration-files",
		),
		...i18nRedirect(
			"/v1/reference/webview-versions",
			"/reference/webview-versions",
		),
...
function i18nRedirect(from, to) {
	...
	Object.keys(locales).map((locale) =>
		locale === "root"
			? (routes[from] = to)
			: (routes[`/${locale}/${from.replaceAll(/^\/*/g, "")}`] =
					`/${locale}/${to.replaceAll(/^\/*/g, "")}`),
	);
	return routes;
}
